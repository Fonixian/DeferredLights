...
#ifdef _DEBUG
    // If the program stops here, some OpenGL error has occurred.
    // 1. The error message is on the console.
    // 2. The Call Stack can be used to find the OpenGL operation that caused the error
    //      (the arrow points to the line following the instruction indicating the error!).
